...
activity_labels <- read.table("F:./UCI HAR Dataset/activity_labels.txt")
...
library(plyr);
Data2<-aggregate(. ~subject_train + Activity_Label, dataSet, mean)
Data2<-Data2[order(Data2$subject_train,Data2$Activity_Label),]
